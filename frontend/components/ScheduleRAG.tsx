  ...
  return (
    <div className="schedule-panel">
      ...
      <div className="schedule-header-row flex flex-col md:flex-row md:items-center justify-between pb-4 border-b border-zinc-700/50">
        <div>
          <h2 className="schedule-title text-xl font-black text-white uppercase tracking-wide">
      ...
      <div className="mt-6 overflow-hidden rounded-xl border border-zinc-700/50 bg-[#1e1f24] shadow-lg flex items-center justify-center aspect-video w-full">
        <video
